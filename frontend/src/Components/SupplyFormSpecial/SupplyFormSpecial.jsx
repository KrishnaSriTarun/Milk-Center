...
import { addNewSupply, addSepcialSupply, getAllSupply } from '../../Services/Supply';
...
function SupplyFormSpecial({ setSubmittedData }) {
      ...
      const handleSubmit = async (e) => {
            ...
            try {
                  ...
                  await addSepcialSupply(supplyData);
...
export default SupplyFormSpecial;
